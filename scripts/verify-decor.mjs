...
assert.ok(stats.triangles<200000,'Layered feathers and thin petals stay inside the revised detail budget: '+stats.triangles);
assert.ok(stats.drawCalls<400,'Static details stay batched inside independent clickable objects');
